...
public class OkHttpUtil {
    ...
    private static void buildHeader(Request.Builder builder, Map<String, String> headers) {
        //build auth header
        builder.addHeader("X-Forwarded-User","aidi.admin").
                addHeader("Cookie","user-token=eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCJ9.eyJleHAiOjIyNTc2NDg4NDUsIlRva2VuVHlwZSI6ImxkYXAiLCJVc2VyTmFtZSI6Inlhbmd4dWUuY2hlbiIsIk9yZ2FuaXphdGlvbiI6InJlZ3VsYXItZW5naW5lZXIiLCJPcmdhbml6YXRpb25JRCI6MX0.2lGubjusRbhq-__D3imMPKpHbkxyWl_yIBip_IqkGKVDGOte2TAfEvf4B4xQ90cQHtoENG3PGCBdndQauX_rKjPBGG1LA4DGIu9x9lP-CwGq2AMraQRWmR_t9wIltMbbpqWL6hgfToPlRkTnhoc8EAAZ1vpG5LFxQSUOESbM-8W5A71JcEAayxNsAjFR83EC8RanJSyAUeVydyVdQgOkVFob6VV9YYJ73CgkTc4KIBI0ir3hVecypXskLVe2PyXbH7D_c3SspCPDlZUkV0AUHXV7HrVQaEQXITJkcsX9sN5XikYJTZlK0yF6dWRhlrz8J4G51ZCkhKBzcdrx8mGh6Q");
